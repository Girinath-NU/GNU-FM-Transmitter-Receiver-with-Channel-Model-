...
class FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Noise_range = qtgui.Range(0, 100, 0.01, 0, 200)
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('D:\\ECE\\5th Semester\\DSP lab\\Journey(chosic.com).wav', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(96e6, self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(98e6, self.samp_rate)
